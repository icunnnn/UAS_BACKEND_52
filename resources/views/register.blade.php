    ...
    <div class="register-box">
        <div class="card card-outline card-success">
            <div class="card-body">
                ...
                <form method="POST" action="{{ url('/register52') }}" class="md-float-material">
                    @csrf
                    ...
                    <button class="btn btn-success btn-block btn-lg shadow-lg">Daftar</button>
                </form>
                <hr>
                <p class="mb-0 text-center">
                    <a>Sudah Punya Akun? </a><a href="{{ url('/login52') }}" class="text-center">Masuk</a>
                </p>
