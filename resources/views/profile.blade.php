                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="settings">
                                            <form class="form-horizontal" action="{{ $URL . '/user52' }}"
                                                method="POST">
                                                @csrf
                    ...
                    <div class="card card-success card-outline">
                        ...
                        <div class="card-body box-profile">
                            ...
                            @if (!$is_preview)
                                ...
                                <form enctype='multipart/form-data' action="{{ $URL . '/user52/photo' }}"
                                    method="POST">
                                    @csrf
                    ...
                    <div class="card card-danger card-outline">
                        <div class="card-body box-profile">
                            ...
                            <div class="text-center">
                                ...
                                @if (!$is_preview)
                                    <form enctype='multipart/form-data' action="{{ $URL . '/user52/photoKTP' }}"
                                        method="POST">
                                        @csrf
