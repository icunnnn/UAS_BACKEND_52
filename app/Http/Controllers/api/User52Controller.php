...
class User52Controller extends Controller
{
    ...
    public function getUserDetail52(Request $request, $id)
    {
    ...
    public function putUserDetail52(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhoto52(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPhotoKTP52(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserPassword52(Request $request, $id)
    {
        $user = User::with('detail')->find($id);
    ...
    public function putUserAgama52(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'id_agama' => 'required|exists:agama52,id',
        ]);
